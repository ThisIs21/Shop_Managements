...
import PurchasingSidebar from "../components/GudangSidebar.vue";
...
const fetchProducts = async () => {
  try {
    ...
    products.value = response.data.data.map((product) => ({
      ...
      stock: Number(product.stock) || 0, // 🔥 pastikan angka
  ...
  >
    <div class="layout-container flex h-full grow flex-col">
      <div class="flex flex-1 justify-center">
        <PurchasingSidebar />
        <div
          class="layout-content-container flex flex-col w-full max-w-[1200px] flex-1 px-6"
        >
          <!-- Header -->
          ...
          <div class="px-4 py-3">
            ...
            <div
              v-else
              class="overflow-x-auto rounded-lg border border-[#dbe0e6] bg-white"
            >
